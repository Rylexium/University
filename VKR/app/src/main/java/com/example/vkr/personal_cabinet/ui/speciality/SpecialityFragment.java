...
import com.example.vkr.personal_cabinet.moreAbout.MoreAboutTheInstitut;
...
public class SpecialityFragment extends Fragment {
    ...
    private void onAddField(String idSpeciality, String nameSpeciality,
        ...
        institut.setOnClickListener(view -> startActivity(new Intent(binding.getContext(), MoreAboutTheInstitut.class)
    ...
    private void downloadSpeciality(){
        ...
        new Thread(()->{
            ...
            try {
                ...
                while (res.next()){
                    speciality.add(asList(res.getString("id"),
                            res.getString("name"),
